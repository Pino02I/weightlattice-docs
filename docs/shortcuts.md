...
- **Enter**: Create the lattice for the active vertex group, or open the existing one in Edit Lattice without modifying it.
- **Double-click Left Mouse**: Same behavior as **Enter**.
- **U**: Refit the lattice bounds to the current weights and reset the cage to its default shape.
